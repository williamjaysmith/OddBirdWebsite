export default function Page() {
  return (
    <div className="grid grid-cols-5 items-center gap-x-24 gap-y-32 text-lg">
      ...
      <div className="col-span-2">
        <img src="/about-2.jpg" alt="Family that manages The Wildernests" />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            ...
            Wildernests, blending the timeless beauty of the mountains with the
            personal touch only a family business can offer. Here, you&apos;re
            not just a guest; you&apos;re part of our extended family. So join
            us at The Wildernests soon, where tradition meets tranquility, and
